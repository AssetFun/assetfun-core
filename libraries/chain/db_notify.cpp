...
struct get_impacted_account_visitor
{
   ...
   void operator()( const account_set_homepage_operation& op ) {}
   ...
   void operator()( const coin_feed_price_operation& op ) {}
   ...
   void operator()( const subject_publish_operation& op )
   {
      _impacted.insert( op.creator );
   }
   void operator()( const subject_vote_operation& op )
   {
      _impacted.insert( op.voter );
   }
   void operator()( const subject_event_operation& op )
   {
      ...
      switch( (object_type)obj->id.type() )
      {
        ...
        case account_object_type:{
          ...
          break;
           ...
           break;
        } case subject_object_type:{
	         break;
	      } case subject_vote_object_type:{
           break;
        } case subject_event_object_type:{
           break;
        } case coin_object_type:{
        	//TODO
//            const auto& cobj = dynamic_cast<const coin_object*>(obj);
//            assert( cobj != nullptr );
//            accounts.insert( aobj->issuer );
            break;
   ...
   else if( obj->id.space() == implementation_ids )
   {
      switch( (impl_object_type)obj->id.type() )
      {
             ...
             case impl_fba_accumulator_object_type:
              break;
             case impl_subject_statistics_object_type:
              break;
             case impl_coin_dynamic_data_type:
            	 break;
             case impl_coin_fixed_data_type:
            	 break;
             case impl_coin_price_data_type:
               break;
...
bool need_to_notify(const object_id_type& object_id)
{
  ...
  bool needToNotify = (
    !(space == implementation_ids && type == impl_coin_dynamic_data_type) &&
    !(space == implementation_ids && type == impl_coin_price_data_type) && 
